...
class InstagramUserModelTest(TestCase):
    ...
    def test_instagram_id_label(self):
        instagram_user = InstagramUser.objects.get(id=1)
        field_label = (instagram_user
                       ._meta.get_field('instagram_id')
                       .verbose_name)
...
class InstagramPostModelTest(TestCase):
    ...
    def test_likes_amount_label(self):
        instagram_post = InstagramPost.objects.get(id=1)
        field_label = (instagram_post
                       ._meta.get_field('likes_amount')
                       .verbose_name)
        self.assertEqual(field_label, 'likes amount')

    def test_comments_amount_label(self):
        instagram_post = InstagramPost.objects.get(id=1)
        field_label = (instagram_post
                       ._meta.get_field('comments_amount')
                       .verbose_name)
        self.assertEqual(field_label, 'comments amount')

    def test_views_amount_label(self):
        instagram_post = InstagramPost.objects.get(id=1)
        field_label = (instagram_post
                       ._meta.get_field('views_amount')
                       .verbose_name)
    ...
    def test_instagram_user_label(self):
        instagram_post = InstagramPost.objects.get(id=1)
        field_label = (instagram_post
                       ._meta.get_field('instagram_user')
                       .verbose_name)
...
class MediaModelTest(TestCase):
    ...
    def test_is_video_label(self):
        media = Media.objects.get(id=1)
        field_label = media._meta.get_field('is_video').verbose_name
        self.assertEqual(field_label, 'is video')
    ...
    def test_instagram_user_label(self):
        media = Media.objects.get(id=1)
        field_label = media._meta.get_field('instagram_user').verbose_name
        self.assertEqual(field_label, 'instagram user')
